            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="alert alert-orange alert-dismissable">
                        ...
                        Welcome <?php echo $_SESSION['ownName'];?> 
                    </div>
                </div>
            </div><!-- /.row -->
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="col-xs-6 text-right">
                            <p class="announcement-heading">
                                <?php
                                    $sql= "SELECT Distinct  COUNT(BID) FROM branch where ownID =".$_SESSION['ownID']."";
                    ...
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-6 text-right">
                                <p class="announcement-heading">      
                                    <?php
                                        $sql= "SELECT  COUNT(empId) FROM employee where EmpActive=0 and BID in (SELECT BID from branch WHERE ownID =".$_SESSION['ownID'].") ";
                                        $result = mysqli_query($conn,$sql);
                                        $row = mysqli_fetch_array($result); 
                                        $quantity = $row[0];
                                        echo $quantity;
                                ...
                                <p class="announcement-text">Number of Deactive Emplyee</p>
                            </div>
                        </div>
                    </div>
                    <a href="deactive_employee.php">
            ...
            <div class="panel panel-warning">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <p class="announcement-heading">
                            <?php
                                $sql= "SELECT  COUNT(empId) FROM employee where BID in (SELECT BID from branch WHERE ownID =".$_SESSION['ownID'].") ";
                                $result = mysqli_query($conn,$sql);
                                $row = mysqli_fetch_array($result); 
                                $quantity = $row[0];
                                echo $quantity;
